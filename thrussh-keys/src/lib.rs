...
-----END OPENSSH PRIVATE KEY-----";
    ...
    #[test]
    #[cfg(feature = "p256")]
    fn test_decode_p256_public_key() {
        parse_public_key_base64(
            "AAAAE2VjZHNhLXNoYTItbmlzdHAyNTYAAAAIbmlzdHAyNTYAAABBBDmt4mv8/EGxVNpzEqkXqOIihUTKWjHa2fUieOBwLTKyv8y8VPmf/BKUuI3A1k3aQjR2NBuB4glem5AgX89mD1Q=",
        )
        .unwrap();
    }
